...
// The shadcn/ui Input (new-york), trimmed to a plain <input> like button.tsx: no extra deps, the
// generator's classes verbatim. `aria-invalid` drives the destructive ring when a field errors.
